...
# Output file is in backend/data_basic/ (same level as database_pipeline)
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "..", "data_basic", "castellers_data.json")
...
# Calculate statistics for NEW events only (from current scrape)
new_events_stats = {
...
# Merge existing and new events for saving to file
...
dataset = {
    "metadata": {
        ...
        "new_events_statistics": new_events_stats  # Statistics for new events only
    },
    "events": all_events
}
