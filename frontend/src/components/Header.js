            ...
            {user ? (
              ...
              <>
                <button 
                  className={`header-nav-btn ${currentPage === 'chat' ? 'active' : ''}`}
                  onClick={() => onPageChange && onPageChange('chat')}
                  title="Tornar a la pàgina d’inici"
                >
                  Xat
                </button>
                <button 
      ...
      {showShareModal && (
        <div className="share-modal-overlay" onClick={() => setShowShareModal(false)}>
          <div className="share-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="share-modal-options-label">Compartir amb</p>
            <div className="share-modal-options">
              <a
                href={`mailto:?subject=${encodeURIComponent('Comparteix Xiquet.cat')}&body=${encodeURIComponent('Mira Xiquet.cat: https://www.xiquet.cat')}`}
                className="share-modal-option-btn share-modal-option-email"
                target="_blank"
              ...
              <a
                href={`https://wa.me/?text=${encodeURIComponent('Comparteix Xiquet.cat: https://www.xiquet.cat')}`}
                className="share-modal-option-btn share-modal-option-whatsapp"
                target="_blank"
                rel="noopener noreferrer"
              >
